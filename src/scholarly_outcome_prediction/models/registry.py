...
from scholarly_outcome_prediction.models.elastic_net_model import build_elastic_net_regressor
from scholarly_outcome_prediction.models.extra_trees_model import build_extra_trees_regressor
from scholarly_outcome_prediction.models.hist_gradient_boosting_model import build_hist_gradient_boosting_regressor
from scholarly_outcome_prediction.models.tweedie_model import build_tweedie_regressor
...
def _build_elastic_net(**kw: Any) -> RegressorMixin:
    return build_elastic_net_regressor(kw.get("params") or {})


def _build_extra_trees(**kw: Any) -> RegressorMixin:
    return build_extra_trees_regressor(kw.get("params") or {})


def _build_hist_gradient_boosting(**kw: Any) -> RegressorMixin:
    return build_hist_gradient_boosting_regressor(kw.get("params") or {})


def _build_tweedie(**kw: Any) -> RegressorMixin:
    return build_tweedie_regressor(kw.get("params") or {})
...
def get_model_builder(name: str) -> Callable[..., RegressorMixin]:
    ...
    registry: dict[str, Callable[..., RegressorMixin]] = {
        ...
        "ridge": _build_ridge,
        "elastic_net": _build_elastic_net,
